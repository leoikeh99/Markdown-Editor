...
export const Preview = ({ showMarkdown, setShowMarkdown }) => {
  ...
  return (
    <div
      className={`${showMarkdown ? "basis-2/4" : "basis-full"} ${
        showMarkdown ? "hidden" : "block"
      } md2:block border-l border-light-gray dark:border-light-gray-4 calcHeight`}>
