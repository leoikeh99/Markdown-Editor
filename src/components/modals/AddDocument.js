...
export const AddDocument = ({ setShowModal }) => {
  ...
  return (
    <>
      ...
      <div className="w-343 p-6 bg-white rounded animate-pop-in fixed top-0 left-0 right-0 bottom-0 m-auto h-fit">
        <h4 className="text-dark-gray text-xl mb-4 font-bold">
          Create new Document
        </h4>
        <label className="text-dark-gray text-sm">Document Name:</label>
        <input
